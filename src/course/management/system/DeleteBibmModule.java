...
class DeleteBibmModule extends JFrame implements ActionListener{
    ...
    public DeleteBibmModule() {
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), "Delete Bibm Module", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(ae.getSource() == b3){
                String sql = "delete from bibmmodule where id=?";
