...
public class BscModule extends JFrame implements ActionListener{
    ...
    public BscModule() {
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), "Manage BscIT Module", TitledBorder.LEADING,
        ...
        comboBox.setBounds(262, 103, 197, 21);
        panel.add(comboBox);
        
        comboBox2 = new JComboBox();
        comboBox2.setModel(new DefaultComboBoxModel(new String[] {"Introductory Programming", "Academic Skills", "Fundamentals of Computing", "Embedded Systems Programming", "Internet Software", "Computational Mathematics", "Concepts and Technologies of AI", "Object-Oriented Design and Programming ", "Numerical Methods and Concurrency", "Distributed and Cloud System Programming ", "Collaborative Development", "Human Computer Interaction", "Complex System", "High Performance Computing ", "Project and Professionalism", "Artificial Intelligence and Machine Learning", "Big Data", "Optional Subject"}));
        comboBox2.setBounds(262, 160, 197, 21);
        panel.add(comboBox2);
        ...
        b6.setBorder(new CompoundBorder(new LineBorder(new Color(105, 105, 105)), null));
        b6.setBackground(new Color(0, 0, 102));
        b6.setBounds(469, 100, 110, 33);
        panel.add(b6);
    ...
    public void actionPerformed(ActionEvent ae){
    	if (ae.getSource()==b6) {
   		 if (((String)comboBox.getSelectedItem()) == "4") {
   			 comboBox2.setModel(new DefaultComboBoxModel(new String[] {"Introductory Programming","Academic Skills","Fundamentals of Computing","Embedded Systems Programming","Internet Software","Computational Mathematics"
                }));
   		 }
   		 else if  (((String)comboBox.getSelectedItem()) == "5") {
   			 comboBox2.setModel(new DefaultComboBoxModel(new String[] {"Concepts and Technologies of AI", "Object-Oriented Design and Programming", "Numerical Methods and Concurrency","Distributed and Cloud System Programming","Collaborative Development","Human Computer Interaction"
                }));
   		 }
   		 else {
   			 comboBox2.setModel(new DefaultComboBoxModel(new String[] { "Complex System", "High Performance Computing", "Project and Professionalism", "Artificial Intelligence and Machine Learning","Big Data","Optional Subject"
                }));
   		 }
   	}
        ...
        try{
            ...
            if(ae.getSource() == b1){
            	if( uu.isModuleExist1(t1.getText())) {
                    JOptionPane.showMessageDialog(null, "Module Exists");}
            	else {
            	 connect con = new connect();
                String sql = "insert into bscmodule(id, name, level, tutor) values(?, ?,?,?)";
            ...
            if(ae.getSource() == b5){
           	 connect con = new connect();
                String sql = "update bscmodule set name =?, level=?,tutor=? where id=?";
                PreparedStatement st = con.c.prepareStatement(sql);
